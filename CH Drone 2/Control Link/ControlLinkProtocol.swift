...
/// source as a plain `String`. The playground passes a `JoystickUIState.ControlSource`,
/// which does not exist on this branch; the field is `String?` on the wire either way.
